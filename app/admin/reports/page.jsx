          ...
          >
            ...
            >
              ...
              <div className="bg-white rounded-xl border p-4 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {mockData.kpis.totalApplications}
                </p>
              </div>
              <div className="bg-white rounded-xl border p-4 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center gap-3 mb-2">
              ...
              <div className="bg-white rounded-xl border p-4 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {mockData.kpis.avgProcessingTime}
                </p>
              </div>
            </motion.div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
              ...
              >
                <h3 className="text-lg font-semibold mb-4 flex items-center gap-2">
                  <TrendingUp size={20} className="text-sky-600" /> Revenue &
                  Applications Trend
                </h3>
              ...
              >
                <h3 className="text-lg font-semibold mb-4 flex items-center gap-2">
                  <BarChart3 size={20} className="text-indigo-600" /> Top
                  Counselors by Revenue
                </h3>
                <div className="h-64 sm:h-80">
              ...
              >
                <h3 className="text-lg font-semibold mb-4 flex items-center gap-2">
                  <Globe size={20} className="text-teal-600" /> Revenue by
                  Country
                </h3>
                <div className="h-64 sm:h-80">
