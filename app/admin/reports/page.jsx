...
export default function ReportsPage() {
  ...
  useEffect(() => {
    // Dummy data – fully populated for all cards and charts
    const mockData = {
      kpis: {
        totalStudents: 487,
    ...
    setTimeout(() => {
      ...
      if (counselorChartRef.current) {
        new Chart(counselorChartRef.current, {
          type: "bar",
          data: {
      ...
      if (countryChartRef.current) {
        new Chart(countryChartRef.current, {
          type: "bar",
          data: {
    ...
    }, 1000); // slight delay to ensure canvas is mounted
  }, [loading]);
          ...
          <motion.div variants={containerVariants} initial="hidden" animate="show" className="space-y-8 max-w-7xl mx-auto">
            ...
            <motion.div variants={itemVariants} className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
              ...
              <div className="bg-white rounded-xl border p-4 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-2xl font-bold text-gray-900">{formatCurrency(1850000)}</p>
              </div>
              <div className="bg-white rounded-xl border p-4 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center gap-3 mb-2">
                ...
                <p className="text-2xl font-bold text-purple-600">76.4%</p>
              </div>
              <div className="bg-white rounded-xl border p-4 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center gap-3 mb-2">
