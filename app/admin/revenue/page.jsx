...
export default function RevenuePage() {
  ...
  useEffect(() => {
    ...
    const mockData = {
      ...
      transactions: [
        { id: "TXN-001", student: "Ahmed Khan", amount: 45000, type: "Visa Fee", counselor: "Sara Ahmed", date: "2026-01-28", status: "Completed" },
        { id: "TXN-002", student: "Priya Sharma", amount: 120000, type: "Application Package", counselor: "John Mathew", date: "2026-01-25", status: "Pending" },
        { id: "TXN-003", student: "Rahul Verma", amount: 75000, type: "Commission", counselor: "Aisha Khan", date: "2026-01-20", status: "Completed" },
        { id: "TXN-004", student: "Sneha Patel", amount: 95000, type: "Visa Fee", counselor: "Sara Ahmed", date: "2026-01-15", status: "Completed" },
        { id: "TXN-005", student: "Vikram Singh", amount: 60000, type: "Counseling Fee", counselor: "John Mathew", date: "2026-01-10", status: "Completed" },
      ],
    };
        ...
        <main className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8">
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6">
              <motion.div variants={itemVariants} className="bg-white rounded-2xl border border-gray-200 shadow-sm p-5 sm:p-6 hover:shadow-md transition-shadow">
              ...
              <motion.div variants={itemVariants} className="bg-white rounded-2xl border border-gray-200 shadow-sm p-5 sm:p-6 hover:shadow-md transition-shadow">
                ...
                <div className="flex items-center gap-1 text-xs mt-1">
                  ...
                  <span className="text-emerald-600 font-medium">{revenueData.growth}%</span>
              ...
              <motion.div variants={itemVariants} className="bg-white rounded-2xl border border-gray-200 shadow-sm p-5 sm:p-6 hover:shadow-md transition-shadow">
                ...
                <p className="text-2xl sm:text-3xl font-bold text-indigo-700">
                  {formatCurrency(Math.round(revenueData.total / 50))} {/* dummy calc */}
                </p>
                <p className="text-xs text-gray-500 mt-1">Based on all applications</p>
              </motion.div>
            </div>
                  ...
                  <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gray-50">
                      <tr>
                        ...
                        <th className="px-4 py-3 sm:px-6 text-left text-xs sm:text-sm font-semibold text-gray-700 hidden sm:table-cell">Type</th>
                        <th className="px-4 py-3 sm:px-6 text-left text-xs sm:text-sm font-semibold text-gray-700">Counselor</th>
                        <th className="px-4 py-3 sm:px-6 text-left text-xs sm:text-sm font-semibold text-gray-700">Amount</th>
                        <th className="px-4 py-3 sm:px-6 text-left text-xs sm:text-sm font-semibold text-gray-700">Date</th>
                    ...
                    <tbody className="divide-y divide-gray-200">
                      {revenueData.transactions.map((tx) => (
                        <tr key={tx.id} className="hover:bg-gray-50 transition-colors">
                          <td className="px-4 py-3 sm:px-6 text-xs sm:text-sm font-medium">{tx.id}</td>
                          <td className="px-4 py-3 sm:px-6 text-xs sm:text-sm">{tx.student}</td>
                          <td className="px-4 py-3 sm:px-6 text-xs sm:text-sm hidden sm:table-cell">{tx.type}</td>
                          <td className="px-4 py-3 sm:px-6 text-xs sm:text-sm">{tx.counselor}</td>
