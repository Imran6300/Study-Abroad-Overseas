        ...
        <section className="py-20 bg-gradient-to-b from-white to-gray-50">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Trusted Study Abroad Consultants in Hyderabad
            </h2>
            ...
            <p className="text-gray-700 text-lg md:text-xl leading-relaxed mb-6">
              ...
              is one of the trusted{" "}
              <span className="font-medium">
                study abroad consultants in Hyderabad
              </span>{" "}
              helping students achieve their dream of studying in top
              universities across the{" "}
              <span className="font-medium">
                USA, UK, Canada, Australia and Germany
              </span>
              . Our experienced counsellors guide students through every stage
              of the international admission journey including profile
              evaluation, university selection, SOP writing, student visa
              assistance and pre-departure support.
            </p>

            <p className="text-gray-600 text-lg md:text-xl leading-relaxed">
              With years of expertise and a strong visa success record, we help
              students secure admissions in globally recognised universities
              while ensuring a transparent, smooth and stress-free process.
            </p>
          </div>
        </section>
        {/* Core Services Grid */}
              ...
              {services.map((service, index) => (
                ...
                >
                  ...
                  <div className="relative h-44 sm:h-48 overflow-hidden">
                    <Image
                      src={service.image}
                      alt={`Study abroad service ${service.title} in Hyderabad`}
                      fill
