    ...
    "
          >
            <div className="flex items-center gap-1.5 xs:gap-2 bg-white/7 px-3.5 xs:px-4 py-1.5 xs:py-2 rounded-full backdrop-blur-sm border border-white/10">
              <Globe className="w-4 h-4 xs:w-5 xs:h-5 text-blue-400" /> 50+
              Countries
            </div>
            <div className="flex items-center gap-1.5 xs:gap-2 bg-white/7 px-3.5 xs:px-4 py-1.5 xs:py-2 rounded-full backdrop-blur-sm border border-white/10">
              <Users className="w-4 h-4 xs:w-5 xs:h-5 text-green-400" /> 10,000+
              Placed
            </div>
            <div className="flex items-center gap-1.5 xs:gap-2 bg-white/7 px-3.5 xs:px-4 py-1.5 xs:py-2 rounded-full backdrop-blur-sm border border-white/10">
              <Award className="w-4 h-4 xs:w-5 xs:h-5 text-yellow-400" /> Up to
              100% Scholarships
            </div>
          </div>
        </motion.div>
